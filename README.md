...
Los aspectos a mejorar serían poder realizar la navegación como tal. Tuvimos algunos problemas, y realmente nos dimos cuenta tarde de que no era necesario integrar los datos del IMU para poder desplazarse y encontrarse con los obstáculos. Para mejorar este aspecto, lo que teníamos planeado era usar todos los sensores para que el robot pueda moverse de manera autónoma por el espacio, con la necesidad de que exista una ruta predefinida pero con la posibilidad de establecer obstáculos "aleatorios" que obliguen al robot a tomar la mejor decisión aparente. Sin embargo, no pudimos resolver estos aspectos y nos quedamos sólo con lo básico, que son las funciones de desplazamiento y detección de objetos dentro del umbral.
